 ...
 * @param vd2 Output Voronoi diagram built in-place with collapsed small edges
 */
void collapseSmallEdges(const VoronoiDiagram &vd, double D, const CGAL::Epick::Iso_cuboid_3 &bbox, Delaunay &dt, std::vector<int> &out_vertex_mapping, VoronoiDiagram &vd2);
